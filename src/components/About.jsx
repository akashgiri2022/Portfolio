        ...
        <div className="container">
            <div className="row">
                <div className="about-col-1">
                    <img src={require("../img/Dp.jpeg")} alt="Profile Pic" />
                </div>
                <div className="about-col-2">
                    ...
                    <div className="tab-contents active-tab" id="skills">
                        <ul>
                            <li><span>Programming Language</span><br />C++, JAVASCRIPT</li>
                            <li><span>Web Developement</span><br />HTML, CSS, JAVASCRIPT, ReactJS, NextJS,Express</li>
                            <li><span>Others</span><br />SQL, GIT, Data Structures</li>
                        </ul>
                    </div>
                    <div className="tab-contents" id="experience">
                        <ul>
                            <li><span>2024/Feb-Current</span><br />MERN Stack Intern (JSPIDER)</li>
                            <li><span>2022/Feb-2022/June</span><br />Intern at Era Interface</li>
                        </ul>
                    </div>
                    <div className="tab-contents" id="education">
                        <ul>
                            <li><span>2018-2022</span><br />Bachelor of Technology in Computer Science</li>
                            <li><span>2016-2018</span><br />12th Science(PCMB)</li>
                            <li><span>2016</span><br />10TH</li>
                        </ul>
                    </div>
                </div>
            </div>
